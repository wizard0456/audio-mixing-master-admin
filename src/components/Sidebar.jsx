    ...
    <div className={`sidebar ${openSidebar ? "active" : ""}`}>
      <div className="fixed top-0 h-full overflow-hidden py-10 bg-[#091600] z-50">
        ...
        <ul className="sidebar-list flex flex-col gap-5 pr-2 mx-5 overflow-auto">
          ...
          <li className="block w-full">
            <NavLink to="/coupons" className={({ isActive }) => `font-semibold text-base leading-4 text-white flex rounded-lg align-center py-3 px-5 gap-2 items-center ${isActive ? "bg-[#0F2005] active" : ""}`}> <span className="icon"><FaTags /></span> <span className="font-semibold relative top-[2px]">Coupons</span></NavLink>
          </li>
          <li className="block w-full">
