                    ...
                    <tr>
                        ...
                        <td className="font-THICCCBOI-SemiBold font-semibold text-base leading-6 pb-5">
                            <div className='flex items-center gap-3 px-3 py-5 bg-[#F6F6F6]'>
                                <button className="bg-[#4BC500] px-3 py-1 rounded-xl font-THICCCBOI-SemiBold font-semibold text-[12px] leading-3 text-white">View Orders</button> <button><FaTrashAlt color="#FF0000" /></button>
                            </div>
                        </td>
                    </tr>
                    <tr>
